...
> [!NOTE]  
> Virtual Desktop Classic is a paid app available on Steam, which can be used to mirror the desktop onto VR headsets, with customizable angle of display, even up to 360 degrees. But Virtual Desktop Classic does not seem to work with iVRy on google cardboard - it seems to need a VR headset like Oculus Rift, HTC Vive, etc.
